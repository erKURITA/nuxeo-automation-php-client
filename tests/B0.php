...
<html>
  ...
  <body>
    <?php include 'nav.php' ?>
    <pre>
      Execute a <code>SELECT * FROM Document ORDER BY ecm:path</code> query to Nuxeo and print all the document properties. This is to ease testing in the other tests.
    </pre>
    <hr />
<?php
